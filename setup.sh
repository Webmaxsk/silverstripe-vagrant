...
if [ ! -e /vagrant/httpd.conf ]; then
    cp /vagrant/public/vagrant/httpd.conf.sample /vagrant/httpd.conf
fi

if [ ! -e /vagrant/_ss_environment.php ]; then
...
if [ -d /vagrant/public/themes/${theme}/ ]; then
    echo 'found theme folder ' ${theme}

    if [ -e /vagrant/public/themes/${theme}/gulpfile.js ]; then
    ...
    elif [[ -e /vagrant/public/themes/${theme}/config.rb && -e /vagrant/public/themes/${theme}/bower.json ]]; then
...
if [ ! -e /vagrant/public/assets/.htaccess ]; then
...
if [ -e /vagrant/public/composer.json ]; then
...
if [ -e /vagrant/public/framework/sake ]; then
